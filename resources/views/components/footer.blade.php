<footer class="border-t border-gray-200 bg-white">
    <div class="max-w-7xl mx-auto px-5 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-16">
            <div class="lg:col-span-2">
                <a href="{{ route('home') }}"><img src="{{ asset('images/logo.png') }}" alt="REKA"
                        class="h-10 mb-6" /></a>
                <p class="text-base leading-relaxed text-gray-500 max-w-sm mb-6">Membangun ekosistem digital yang handal melalui pengembangan software strategis, desain sistem yang scalable, dan teknologi tepat guna untuk pertumbuhan bisnis Anda.</p>
                {{-- <div
                ...
                <div class="flex flex-col gap-3 mb-6">
                    <a href="mailto:hello@solusidigital.jasanya.id"
                        class="text-sm text-gray-500 hover:text-gray-950 transition-colors flex items-center gap-2.5">
                ...
                <div class="flex gap-4">
                    <a href="#" class="text-gray-400 hover:text-gray-950 transition-colors" aria-label="Linkedin">
                    ...
                    <a href="#" class="text-gray-400 hover:text-gray-950 transition-colors" aria-label="Facebook">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round">
                    ...
                    <a href="#" class="text-gray-400 hover:text-gray-950 transition-colors"
            ...
            <div>
                <h4 class="font-grotesk text-sm font-semibold mb-6 text-gray-900 uppercase tracking-widest">Layanan</h4>
            ...
            <div>
                <h4 class="font-grotesk text-sm font-semibold mb-6 text-gray-900 uppercase tracking-widest">Perusahaan</h4>
                <ul class="flex flex-col gap-3 list-none">
            ...
            <div>
                <h4 class="font-grotesk text-sm font-semibold mb-6 text-gray-900 uppercase tracking-widest">Produk</h4>
                <ul class="flex flex-col gap-3 list-none">
