            ...
            <div class="lg:col-span-2">
                ...
                <div
                    ...
                    Bagian dari <a href="https://jasanya.id" target="_blank"
                        class="font-semibold text-gray-950 flex items-center gap-1">Jasanya.id <i
                            data-lucide="external-link" class="w-2.5 h-2.5"></i></a></div>
                <div class="flex flex-col gap-2 mb-4">
                    <a href="mailto:hello@solusidigital.jasanya.id"
                        class="text-sm text-gray-500 hover:text-gray-950 transition-colors flex items-center gap-2"><i
                            data-lucide="mail" class="w-3.5 h-3.5"></i>hello@solusidigital.jasanya.id</a>
                    <a href="https://wa.me/6281234567890"
                        class="text-sm text-gray-500 hover:text-gray-950 transition-colors flex items-center gap-2"><i
                            data-lucide="message-circle" class="w-3.5 h-3.5"></i>+62 812-3456-7890</a>
                </div>
                <div class="flex gap-2">
                    <a href="#"
                        ...
                        aria-label="Github"><i data-lucide="github" class="w-4 h-4"></i></a>
                    <a href="#"
                        class="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-100 text-gray-500 border border-gray-200 hover:bg-gray-950 hover:text-white transition-colors"
                        aria-label="Linkedin"><i data-lucide="linkedin" class="w-4 h-4"></i></a>
                    <a href="#"
                        class="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-100 text-gray-500 border border-gray-200 hover:bg-gray-950 hover:text-white transition-colors"
                        aria-label="Instagram"><i data-lucide="instagram" class="w-4 h-4"></i></a>
                    <a href="#"
                        class="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-100 text-gray-500 border border-gray-200 hover:bg-gray-950 hover:text-white transition-colors"
                        aria-label="Twitter"><i data-lucide="twitter" class="w-4 h-4"></i></a>
                </div>
            </div>
            <div>
                ...
                <ul class="flex flex-col gap-2.5 list-none">
                    <li><a href="{{ route('layanan') }}"
                            class="text-sm text-gray-500 hover:text-gray-950 transition-colors">Custom Software</a></li>
                    <li><a href="{{ route('layanan') }}"
                            class="text-sm text-gray-500 hover:text-gray-950 transition-colors">Web Development</a></li>
                    <li><a href="{{ route('layanan') }}"
        ...
        <div
            ...
            <div class="flex items-center gap-5 flex-wrap">
                <div class="flex items-center gap-2.5">
                    ...
                    <span class="font-grotesk text-sm font-bold text-yellow-500 tracking-[-0.03em]">Jasanya.id</span>
                </div>
                <div class="flex gap-2">
                    <a href="#"
                        class="w-7 h-7 rounded-full flex items-center justify-center bg-gray-100 border border-gray-200 text-gray-500 hover:bg-gray-300 transition-colors"><i
                            data-lucide="linkedin" class="w-3 h-3"></i></a>
                    <a href="#"
                        class="w-7 h-7 rounded-full flex items-center justify-center bg-gray-100 border border-gray-200 text-gray-500 hover:bg-gray-300 transition-colors"><i
                            data-lucide="instagram" class="w-3 h-3"></i></a>
                    <a href="#"
                        class="w-7 h-7 rounded-full flex items-center justify-center bg-gray-100 border border-gray-200 text-gray-500 hover:bg-gray-300 transition-colors"><i
                            data-lucide="twitter" class="w-3 h-3"></i></a>
                    <a href="#"
                        class="w-7 h-7 rounded-full flex items-center justify-center bg-gray-100 border border-gray-200 text-gray-500 hover:bg-gray-300 transition-colors"><i
